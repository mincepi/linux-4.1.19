 ...
 *
 *   This module only works on the B+, A+, and 2 models. It could be altered for the Rev 2 A and B, but they would need a connection to P5.
 *
 ...
 *
 *   For more information see https://sites.google.com/site/thepihacker/analog2pi
 *
 */
