...
int pcmlin (sample)
{
    ...
    linear = sample;
    linear = 876.046 - (19.8876 * linear) + (.202483 * pow(linear, 2)) - (.00108566 * pow(linear, 3)) + (.00000233633 * pow(linear, 4));
    point = linear;
//    if (point < 0) return 0;
...
int spilin (sample)
{
    ...
    linear = sample;
    linear = 654.536 - (18.5095 * linear) + (.248049 * pow(linear, 2)) - (.00193036 * pow(linear, 3)) + (.00000633645 * pow(linear, 4));
    point = linear;
//    if (point < 0) return 0;
//    if (point > 300) return 300;
    return (point);
