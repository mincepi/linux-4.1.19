...
//    static char point;
    ...
    linear = sample;
    linear = (.00000261684 * pow(linear, 4)) - (.00118923 * pow(linear, 3)) + (.217488 * pow(linear, 2)) - (21.0253 * linear) + 917.687;
...
//    static char point;
    ...
    linear = sample;
    linear = (.00000696715 * pow(linear, 4)) - (.00209011 * pow(linear, 3)) + (.264273 * pow(linear, 2)) - (19.4566 * linear) + 683.587;
